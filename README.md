...
Just a simple python code using **pypresence**, that can adjust your Discord Rich Presence.
...
## Dependencies
All dependencies are in **dependencies.bat** just open it to download them.
